...
const About = () => {
  return (
    <>
      <PageHelmet pageName="About" />
      <Container>
        <div id="about_image" className="relative w-full my-16 px-2">
          <img
          ...
          <div className="absolute flex h-full w-full items-center lg:bg-gradient-to-l from-[#1d1c1c6b] to-[rgba(21, 21, 21, 0.00)] rounded-xl top-0 left-0">
            <div className="bg-gray-200 mx-auto text-gray-700 w-1/2 p-2 lg:p-10 hidden lg:block">
              ...
              <p className="text-center text-xs md:text-base md:text-left">
                We believe that together we can build a world where all people
                can lead free and dignified lives. Meet our team and see where
                we came from, what we do, and where we are going.
              </p>
            </div>
          </div>
